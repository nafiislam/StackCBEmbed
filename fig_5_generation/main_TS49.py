...
y_proba = pd.read_csv('./prev_paper/capsifg_y_proba_TS49.csv', header=None).values
...
y_proba = pd.read_csv('./prev_paper/capsifv_y_proba_TS49.csv', header=None).values
fpr, tpr, thresholds = roc_curve(y, y_proba)
print('fpr : ', fpr)
print('tpr : ', tpr)
fprs.append(fpr)
...
y_proba = pd.read_csv('./prev_paper/ps_s_y_proba_TS49.csv', header=None).values
fpr, tpr, thresholds = roc_curve(y, y_proba)
print('fpr : ', fpr)
print('tpr : ', tpr)
fprs.append(fpr)
...
y_proba = pd.read_csv('./prev_paper/ps_g_y_proba_TS49.csv', header=None).values
fpr, tpr, thresholds = roc_curve(y, y_proba)
print('fpr : ', fpr)
print('tpr : ', tpr)
fprs.append(fpr)
