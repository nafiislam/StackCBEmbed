...
class ResidueRNN(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, output_size):
        super(ResidueRNN, self).__init__()
...
input_size = 1024 
output_size = 1280
model = ResidueRNN(input_size=input_size, hidden_size=hidden_size, num_layers=num_layers, output_size=output_size)

model.load_state_dict(torch.load('ResidueRNN.pth'))
model.eval()
